  ...
  return (
    <div className="ops-app">
      <aside className="ops-sidebar">
        <div className="ops-brand"><div className="ops-mark">R</div><div><strong>Relay Rider</strong><span>Pasadena Mobility Intelligence</span></div></div>
      ...
      <section className="ops-main">
        <header className="ops-topbar"><div><small>PASADENA PUBLIC MOBILITY EVIDENCE</small><h1>{title}</h1></div><div className="ops-top-actions"><button className="ghost" onClick={() => window.print()}>Print</button></div></header>
...
function Programs() { return <Panel title="Mobility programs"><div className="ops-empty"><strong>No Pasadena or PCC program outcome data are claimed here.</strong><p>Programs should be added only when there is a real institution-sponsored program, defined observation period, owner, and measurable evidence source.</p></div></Panel>; }
